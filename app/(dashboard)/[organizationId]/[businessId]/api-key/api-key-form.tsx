  ...
  function onSubmit(data: CreateApiKeyDto) {
    try {
      ...
      toaster.toast({
        ...
        variant: 'destructive',
        description: 'An issue occurred while creating your key. Please try again.'
      })
    }
  }
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>Enter a name for your token to differentiate it from other tokens.</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
                  ...
                  <Popover>
                    <PopoverTrigger asChild>
                      <FormControl>
                        ...
                        >
                          {field.value ? locationData.find((loc) => loc.id === field.value)?.name : 'Select location'}
