...
export default function MembershipForm({ chapters }: MembershipFormProps) {
  ...
  const defaultValues: MemberRegistrationForm = {
    ...
    opLastName: 'aaaLN',
    opFirstName: 'aaaFN',
    opPhImageUrl: 'https://uploadthing.com/f/eb031187-82bf-4783-be1e-a1af2c53c7b1-vv7o4m.png',
    fdaLtoNo: 'FDA123',
    ...
    bpUrlAttachment: 'https://uploadthing.com/f/eb031187-82bf-4783-be1e-a1af2c53c7b1-vv7o4m.pdf',
    docNo: 'FDA123',
    docDateIssued: new Date(),
    docDateExpiry: new Date(),
    docUrlAttachment: 'https://uploadthing.com/f/eb031187-82bf-4783-be1e-a1af2c53c7b1-vv7o4m.pdf',
