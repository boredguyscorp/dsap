...
const EditorHtmlContent = dynamic(
	() => import("@/components/advance-text-editor/editor-html-content"),
	{ ssr: false },
);
		...
		<>
			<section className="relative mt-24 flex min-h-[calc((100vh-6rem))] flex-col items-center justify-center text-center text-white ">
				...
				<div className="video-content z-10 space-y-2">
					...
					<h3 className="text-[20px] font-light md:text-2xl xl:text-3xl">
						{siteConfig.name}
					</h3>
				</div>
				...
				<div className="z-10 mt-5 flex justify-center space-x-4 ">
					<Link
						href="/membership"
						className={cn(
							buttonVariants({ variant: "main", size: "lg" }),
							"min-h-[100px]",
						)}
					>
						Become a Member
						...
						<div className="mx-auto max-w-[85rem] px-4 pb-10 pt-10 sm:px-6 lg:px-8">
							<div className="mx-auto mt-5 max-w-2xl text-center">
								<h1 className="block text-2xl font-bold text-gray-800 dark:text-gray-200 lg:text-3xl">
									...
									<span className="bg-gradient-to-br from-teal-400 to-teal-500 bg-clip-text text-transparent">
										President{" "}
									</span>{" "}
								</h1>
							</div>
							...
							<div className="mx-auto mt-5 max-w-3xl text-center">
								<p className="text-lg text-gray-600 dark:text-gray-400">
									<Balancer>
										In behalf of the DSAP Board of Directors, I am happy to
										welcome you back to our upgraded DSAP website. Our new
										website is now user friendly making it easier to access the
										information you need on demand. I encourage you to
										experience the changes we have incorporated in our new site
										and feel the warm embrace of being a member of our
										association.
									</Balancer>
								</p>
							</div>
							...
							<div className="relative flex h-full flex-col">
								...
								<div className="relative z-10 mx-auto text-center">
									<p className="serif px-6 py-6 text-xl font-normal italic text-gray-600 md:px-16 md:py-10 md:text-4xl">
										...
										<span className="text-lg md:text-xl">--Isaiah 60:22</span>
									</p>
								</div>
								...
								<div className="mx-auto mt-5 max-w-3xl space-y-12 text-center">
									<Balancer>
										<p className="text-lg text-gray-600 dark:text-gray-400">
											We have been blessed to go with the trend and to make the
											innovations happen. This is the TIME for DSAP.
										</p>
									</Balancer>
								...
								<div className="mt-10 text-center">
									...
									/>
									<h2 className="text-sm font-bold leading-tight text-gray-700 md:text-xl">
										Vicente U. Briones, RPh.
									</h2>
									<small className="truncate text-xs text-gray-500 md:text-sm">
										DSAP National President 2023
									</small>
								</div>
							</div>
						</div>
				...
				<div className="mx-auto max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
					<div className="mx-auto mb-10 max-w-2xl text-center lg:mb-14">
						...
						<p className="mt-1 text-gray-600 dark:text-gray-400">
							Discover DSAP's work for every community, everywhere.
						</p>
					</div>
			...
			<section className="mb-20">
				<div className="mx-auto max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
					<div className="mx-auto mb-10 max-w-2xl text-center lg:mb-14">
						...
						<p className="mt-1 text-gray-600 dark:text-gray-400">
							Check our latest news and updates about DSAP.
						</p>
					</div>
