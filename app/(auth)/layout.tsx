      ...
      <div className='relative grid min-h-screen grid-cols-1 overflow-hidden md:grid-cols-3 lg:grid-cols-2'>
        <div className='relative'>
          <div
            ...
            // style={{
            //   backgroundImage: 'url(/_static/illustrations/girl-animate.svg)'
            // }}
            style={{
              backgroundImage:
          ...
          <Link href='/' className='absolute left-8 top-8 z-20 flex items-center text-lg font-bold tracking-tight'>
